...
contract pruebas {
    ...
    uint256 public bsasTimestamp;

    // UTC-3 in seconds// Buenos Aires time zone (UTC-3)
    uint256 constant BUENOS_AIRES_OFFSET = (3 * 3600); // TO DECREMENT
    ...
    bsasTimestamp = storedTimestamp - BUENOS_AIRES_OFFSET;
    
    (yearT, monthT, dayT, hourT, minuteT, secondT) = timestampToDateTime(bsasTimestamp); 
